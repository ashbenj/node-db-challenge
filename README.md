...
SQL is a standard language that is supported no matter how your database is managed. Relational database is data stored in tabular format grouped into rows and columns like spreadsheets.

- [ ] Why do tables need a `primary key`?

Tables need primary keys to contain a unique value that is used to identify each and every row of a table uniquely.
...
You have to create join table between two tables by using foreign keys.
